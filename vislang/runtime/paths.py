...
# vislang/runtime/paths.py -> the repo root is three levels up. Every other
# module that needs a repo-relative path (the askpass helper, instructions/,
# the commit stamp on a timing record) imports REPO_ROOT from here rather than
# recomputing its own depth.
